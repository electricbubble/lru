// edited by /usr/local/go/src/container/list/list_test.go

package list

import "testing"

func checkListLen[V any](t *testing.T, l *List[V], len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers[V any](t *testing.T, l *List[V], es []*Element[V]) {
	root := &l.root
...
func TestList(t *testing.T) {
	...
	checkListPointers(t, l, []*Element[any]{e3, e1, e4})
...
func TestExtending(t *testing.T) {
	...
	l3 := New[int]()
	l3.PushBackList(l1)
	checkList[int](t, l3, []int{1, 2, 3})
	l3.PushBackList(l2)
	checkList[int](t, l3, []int{1, 2, 3, 4, 5})

	l3 = New[int]()
	l3.PushFrontList(l2)
	checkList[int](t, l3, []int{4, 5})
	l3.PushFrontList(l1)
	checkList[int](t, l3, []int{1, 2, 3, 4, 5})

	checkList[int](t, l1, []int{1, 2, 3})
	checkList[int](t, l2, []int{4, 5})

	l3 = New[int]()
	l3.PushBackList(l1)
	checkList[int](t, l3, []int{1, 2, 3})
	l3.PushBackList(l3)
	checkList[int](t, l3, []int{1, 2, 3, 1, 2, 3})
...
func TestZeroList(t *testing.T) {
	var l1 = new(List[int])
	l1.PushFront(1)
	checkList[int](t, l1, []int{1})

	var l2 = new(List[int])
	l2.PushBack(1)
	checkList[int](t, l2, []int{1})

	var l3 = new(List[int])
	l3.PushFrontList(l1)
	checkList[int](t, l3, []int{1})

	var l4 = new(List[int])
	l4.PushBackList(l2)
	checkList[int](t, l4, []int{1})
}
